...
def login():
    ...
    Label(login_screen, text="").pack()
    Button(login_screen, text="Login", width=10, height=1, bg="magenta", command = login_verify).pack()
...
def login_sucess():
    ...
    Button(login_success_screen, text="OK", bg="cyan", command=delete_login_success).pack()
...
def main_account_screen():
    ...
    Label(text="Select Your Choice", bg="light green", width="300", height="2", font=("Times New Roman", 16)).pack()
    Label(text="").pack()
    Button(text="Login", height="2", width="30", bg="magenta", command = login).pack()
    Label(text="").pack()
    Button(text="Register", height="2", width="30",bg="cyan", command=register).pack()
